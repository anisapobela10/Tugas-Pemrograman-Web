...
Repository ini berisi kumpulan tugas mata kuliah **Pemrograman Web**, dikerjakan oleh:
...
| Folder | Deskripsi Tugas | Teknologi |
|--------|------------------|-----------|
| `Tugas-1` | Portal artikel W3C               | HTML     |
| `Tugas-2` | Halaman Daftar Publikasi Dosen   | HTML     |
| `Tugas-3` | Pemutar Media responsif          | HTML,CSS |
| `Tugas-4` | Portal Jurnal Ilmiah Multi kolom | HTML,CSS |

## Cara Melihat Riwayat Pengerjaan (Commit History)
...
Struktur folder ini dibuat di akhir pengerjaan untuk memudahkan navigasi, tidak mengubah maupun menghapus riwayat commit yang sudah ada sebelumnya.
